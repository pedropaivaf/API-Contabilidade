...
async def emitir_das(payload: EmitirDASRequest, idempotency_key: UUID = Header(alias="Idempotency-Key")) -> dict:
    ...
    return {"operacaoId": str(idempotency_key), "status": "CONCLUIDA", "resultado": resultado}
